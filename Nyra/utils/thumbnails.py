...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("Nyra/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('Nyra/assets/font.ttf', 30)
            font2 = ImageFont.truetype('Nyra/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('Nyra/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('Nyra/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "NYRA x MUSIC", fill="white", font = font1, align ="left") 
