...
from Nyra import app
from Nyra.core.call import Nyra
from Nyra.misc import db
from Nyra.utils.database import get_authuser_names, get_cmode
from Nyra.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Nyra.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Nyra.stop_stream(message.chat.id)
    except:
        pass
